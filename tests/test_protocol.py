...
from transportcert.protocol import FrozenSplit, assert_disjoint_splits, deterministic_partition
...
def test_hash_partition_is_order_independent_and_disjoint() -> None:
    ...
    forward = deterministic_partition(ids, fractions, "transportcert-v1")
    reverse = deterministic_partition(reversed(ids), fractions, "transportcert-v1")
