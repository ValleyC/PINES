...
fixed-point loss versus $98.7\%$ for a 97-label QAT baseline, while both retain
roughly 21-point certificates. Sequestered replication and physical certificates
remain unfinished.
\end{abstract}
