...
only 18.8\% of SHD inputs over the broad high-risk family, crossing our declared
pivot threshold. This draft reports that formulation failure explicitly;
sequestered replication and physical certificates remain unfinished.
\end{abstract}
