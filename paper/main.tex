...
and convolutional/recurrent DVS Gesture. This draft reports that formulation
failure explicitly; sequestered replication and physical certificates remain
unfinished.
\end{abstract}
