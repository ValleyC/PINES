...
A second development variant minimizes the worst reference-class loss over a
sampled timestep/threshold family. It is selected by joint prediction identity
on the calibration grid, then evaluated on a denser disjoint audit grid. Because
recurrent threshold branches can change between sampled points, this objective
also remains a transport surrogate rather than a family certificate.
