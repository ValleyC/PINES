...
def main() -> None:
    ...
    parser.add_argument("--output-root", default="artifacts/nmnist_v1_semantics")
    ...
    summary = run_shd_semantic_matrix(
        seed_dir / "model.npz",
        PackedNMNIST(root / args.data_root / "train.npz"),
        PackedNMNIST(root / args.data_root / "test.npz"),
